export const Search = () => {
  return (
    ...
    <ul role="list" className="divide-y divide-gray-100 [&>*]:py-2">
      <li className>
        <a className="transition-all hover:text-emerald-600" href="#">How to create a new component in Vue.js</a>
      </li>
      <li className>
        <a className="transition-all hover:text-emerald-600" href="#">How to create a new component in React.js</a>
      </li>
      <li className>
        <a className="transition-all hover:text-emerald-600" href="#">Next.js Routing</a>
      </li>
      <li className>
        <a className="transition-all hover:text-emerald-600" href="#">SSR - What is it?</a>
      </li>
    </ul>
  </div> */}
    </div>
